...
function get_voo_smv_60()::DataFrame
  HTTP.get(ALPHA_URL_PRE*SMA*VOO*WEEKLY*PERIOD_60_TYPE_CLOSE*CSV_TYPE*API_KEY*ENV["ALPHA_VANTAGE_API_KEY"]).body |>
    String |>
    IOBuffer |>
    CSV.File |>
    DataFrame
...
function get_voo_smv_200()::DataFrame
  HTTP.get(ALPHA_URL_PRE*SMA*VOO*WEEKLY*PERIOD_200_TYPE_CLOSE*CSV_TYPE*API_KEY*ENV["ALPHA_VANTAGE_API_KEY"]).body |>
    String |>
    IOBuffer |>
    CSV.File |>
    DataFrame
